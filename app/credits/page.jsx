            ...
            <div className="flex justify-center items-center min-h-screen mt-10">
                <div className="w-full sm:w-[90%] md:w-[80%] lg:w-[70%] xl:max-w-[60%] 2xl:max-w-[50%] mb-10 px-4 lg:px-0">
                    ...
                    <div>
                        ...
                        <ul className="text-base sm:text-lg lg:text-xl italic list-disc px-4">
                            <li className='hover:bg-white hover:text-black'>This project is based on
                                <Link href={'https://github.com/QiskitFallFest23-UNIPA/QiskitFallFest23-UNIPA.github.io'} className="hover:underline text-[#9D5CFD] mt-5"> code </Link>
                                originally developed for the 
                                <Link href={'https://qiskitfallfest23-unipa.github.io/'} className="hover:underline text-[#9D5CFD] mt-5"> Qiskit Fall Fest 2023 @ Palermo </Link> 
                                event by Alberto Miserendino, Alessandro Catalano, Gabriele Lo Cascio, Roberto Battaglia, Giovanni La Tona.
                            </li>
                        </ul>                        
                    </div>
                </div>
